# Udacity Project6: Frontend Nanodegree Feedreader Testing
## Project Overview
...
10. Write a test that ensures the menu element is hidden by default. I'll have to analyze the HTML and the CSS to determine how we're performing the hiding/showing of the menu element.
...
14. When complete - all of my tests should pass.